...
/* main function */
function ar_main() {
	//在web.xml中需要匹配好Servlet的提交地址
	//收集完日志 提交到的路径
	var dest_path   = "http://localhost/FluxDemo/servlet/LogServlet?"; 
    ...
    //通过插入图片访问该地址(还可以通过ajax来实现)
	//每次访问插入该js文件的网页时,当页面加载完,调用函数,此处都请求插入张图片,所以会提交数据到后台
